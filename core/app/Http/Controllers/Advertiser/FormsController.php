...
class FormsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
         ...
         if ($validator->fails()) {
            return response()->json(['success'=>false, 'form_id'=>false , 'form_name'=> $data['error'] = $validator->errors()->first() ]);;
         }else{
        ...
        if($campaign_forms->save()){
            return response()->json(['success'=>true, 'form_id'=>$campaign_forms->id , 'form_name'=> $campaign_forms->form_name  ]);;
        }else{
            return response()->json(['success'=>false, 'form_id'=>false , 'form_name'=>'Try Again!' ]);;
        }
    }
    }
}
