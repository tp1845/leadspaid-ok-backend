        ...
        <header>
            <nav class="navbar navbar-expand-lg bg-primary " id="MainNav">
                ...
                <a class="navbar-brand fw-bold logo" href="{{route('home')}}">
                    ...
                    <img src="{{asset('assets/templates/leadpaid/images/logo-18.6-7-3-3-noborder-2.png?v4')}}" style="max-width: 250px" alt="site-logo">
                    ...
                    @elseif(Request::get('v') == '18-b-rectangle-60')
