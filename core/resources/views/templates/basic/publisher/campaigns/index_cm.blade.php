                            ...
                            <tbody>
                                @forelse($campaigns as $campaign)
                                    <tr>
                                        ...
                                        {{-- Urls --}}
                                        <td data-label="url">
                                                <textarea disabled rows="2" placeholder="publisher_url 1" name="url[url_1]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->url['url_1'] ?? '' }}</textarea>
                                                <textarea disabled rows="2" placeholder="Created By 1" name="url[created_by_1]" data-cid='{{$campaign->id}}'   class="my-2 form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->url['created_by_1'] ?? '' }}</textarea>
                                                <textarea disabled rows="2" placeholder="Remarks 1" name="url[remarks_1]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->url['remarks_1'] ?? '' }}</textarea>
                                         </td>
                                        <td data-label="url">
                                            <textarea disabled rows="2" placeholder="publisher_url 2" name="url[url_2]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->url['url_2'] ?? '' }}</textarea>
                                            <textarea disabled rows="2" placeholder="Created By 2" name="url[created_by_2]" data-cid='{{$campaign->id}}'   class="my-2 form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->url['created_by_2'] ?? '' }}</textarea>
                                            <textarea disabled rows="2" placeholder="Remarks 2" name="url[remarks_2]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->url['remarks_2'] ?? '' }}</textarea>
                                        </td>
                                        <td data-label="url">
                                            <textarea disabled rows="2" placeholder="publisher_url 3" name="url[url_3]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->url['url_3'] ?? '' }}</textarea>
                                            <textarea disabled rows="2" placeholder="Created By 3" name="url[created_by_3]" data-cid='{{$campaign->id}}'   class="my-2 form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->url['created_by_3'] ?? '' }}</textarea>
                                            <textarea disabled rows="2" placeholder="Remarks 3" name="url[remarks_3]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->url['remarks_3'] ?? '' }}</textarea>
                                        </td>
                                        <td data-label="url">
                                            <textarea disabled rows="2" placeholder="publisher_url 4" name="url[url_4]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->url['url_4'] ?? '' }}</textarea>
                                            <textarea disabled rows="2" placeholder="Created By 4" name="url[created_by_4]" data-cid='{{$campaign->id}}'   class="my-2 form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->url['created_by_4'] ?? '' }}</textarea>
                                            <textarea disabled rows="2" placeholder="Remarks 4" name="url[remarks_4]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->url['remarks_4'] ?? '' }}</textarea>
                                        </td>
                                        <td data-label="url">
                                            <textarea disabled rows="2" placeholder="publisher_url 5" name="url[url_5]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->url['url_5'] ?? '' }}</textarea>
                                                <textarea disabled rows="2" placeholder="Created By 5" name="url[created_by_5]" data-cid='{{$campaign->id}}'   class="my-2 form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->url['created_by_5'] ?? '' }}</textarea>
                                                <textarea disabled rows="2" placeholder="Remarks 5" name="url[remarks_5]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->url['remarks_5'] ?? '' }}</textarea>
                                        </td>
                                        <td data-label="url">
                                            <textarea disabled rows="2" placeholder="publisher_url 6" name="url[url_6]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->url['url_6'] ?? '' }}</textarea>
                                                <textarea disabled rows="2" placeholder="Created By 6" name="url[created_by_6]" data-cid='{{$campaign->id}}'   class="my-2 form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->url['created_by_6'] ?? '' }}</textarea>
                                                <textarea disabled rows="2" placeholder="Remarks 6" name="url[remarks_6]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->url['remarks_6'] ?? '' }}</textarea>
                                        </td>
                                        </form>
                                    </tr>
                                @empty
