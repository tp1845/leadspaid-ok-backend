                            ...
                            <tbody>
                                @forelse($campaigns as $campaign)
                                    <tr>
                                        ...
                                        {{-- Urls --}}
                                        <td data-label="url">
                                            <textarea rows="2" placeholder="Planned_url 1" name="planned[url_1]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->planned['url_1'] ?? '' }}</textarea>
                                            <textarea rows="2" placeholder="Planned Remarks 1" name="planned[remarks_1]" data-cid='{{$campaign->id}}'   class="my-2 form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->planned['remarks_1'] ?? '' }}</textarea>
                                            <hr>
                                            <textarea rows="2" placeholder="publisher_url 1" name="url[url_1]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher_common->url['url_1'] ?? '' }}</textarea>
                                            <textarea rows="2" placeholder="Created By 1" name="url[created_by_1]" data-cid='{{$campaign->id}}'   class="my-2 form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher_common->url['created_by_1'] ?? '' }}</textarea>
                                            <textarea rows="2" placeholder="Remarks 1" name="url[remarks_1]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher_common->url['remarks_1'] ?? '' }}</textarea>
                                         </td>
                                        <td data-label="url">
                                            <textarea rows="2" placeholder="Planned_url 2" name="planned[url_2]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->planned['url_2'] ?? '' }}</textarea>
                                            <textarea rows="2" placeholder="Planned Remarks 2" name="planned[remarks_2]" data-cid='{{$campaign->id}}'   class="my-2 form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->planned['remarks_2'] ?? '' }}</textarea>
                                            <hr>
                                            <textarea rows="2" placeholder="publisher_url 2" name="url[url_2]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher_common->url['url_2'] ?? '' }}</textarea>
                                            <textarea rows="2" placeholder="Created By 2" name="url[created_by_2]" data-cid='{{$campaign->id}}'   class="my-2 form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher_common->url['created_by_2'] ?? '' }}</textarea>
                                            <textarea rows="2" placeholder="Remarks 2" name="url[remarks_2]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher_common->url['remarks_2'] ?? '' }}</textarea>
                                        </td>
                                        <td data-label="url">
                                            <textarea rows="2" placeholder="Planned_url 3" name="planned[url_3]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->planned['url_3'] ?? '' }}</textarea>
                                            <textarea rows="2" placeholder="Planned Remarks 3" name="planned[remarks_3]" data-cid='{{$campaign->id}}'   class="my-2 form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->planned['remarks_3'] ?? '' }}</textarea>
                                            <hr>
                                            <textarea rows="2" placeholder="publisher_url 3" name="url[url_3]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher_common->url['url_3'] ?? '' }}</textarea>
                                            <textarea rows="2" placeholder="Created By 3" name="url[created_by_3]" data-cid='{{$campaign->id}}'   class="my-2 form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher_common->url['created_by_3'] ?? '' }}</textarea>
                                            <textarea rows="2" placeholder="Remarks 3" name="url[remarks_3]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher_common->url['remarks_3'] ?? '' }}</textarea>
                                        </td>
                                        <td data-label="url">
                                            <textarea rows="2" placeholder="Planned_url 4" name="planned[url_4]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->planned['url_4'] ?? '' }}</textarea>
                                            <textarea rows="2" placeholder="Planned Remarks 4" name="planned[remarks_4]" data-cid='{{$campaign->id}}'   class="my-2 form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->planned['remarks_4'] ?? '' }}</textarea>
                                            <hr>
                                            <textarea rows="2" placeholder="publisher_url 4" name="url[url_4]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher_common->url['url_4'] ?? '' }}</textarea>
                                            <textarea rows="2" placeholder="Created By 4" name="url[created_by_4]" data-cid='{{$campaign->id}}'   class="my-2 form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher_common->url['created_by_4'] ?? '' }}</textarea>
                                            <textarea rows="2" placeholder="Remarks 4" name="url[remarks_4]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher_common->url['remarks_4'] ?? '' }}</textarea>
                                        </td>
                                        <td data-label="url">
                                            <textarea rows="2" placeholder="Planned_url 5" name="planned[url_5]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->planned['url_5'] ?? '' }}</textarea>
                                            <textarea rows="2" placeholder="Planned Remarks 5" name="planned[remarks_5]" data-cid='{{$campaign->id}}'   class="my-2 form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->planned['remarks_5'] ?? '' }}</textarea>
                                            <hr>
                                            <textarea rows="2" placeholder="publisher_url 5" name="url[url_5]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher_common->url['url_5'] ?? '' }}</textarea>
                                            <textarea rows="2" placeholder="Created By 5" name="url[created_by_5]" data-cid='{{$campaign->id}}'   class="my-2 form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher_common->url['created_by_5'] ?? '' }}</textarea>
                                            <textarea rows="2" placeholder="Remarks 5" name="url[remarks_5]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher_common->url['remarks_5'] ?? '' }}</textarea>
                                        </td>
                                        <td data-label="url">
                                            <textarea rows="2" placeholder="Planned_url 6" name="planned[url_6]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->planned['url_6'] ?? '' }}</textarea>
                                            <textarea rows="2" placeholder="Planned Remarks 6" name="planned[remarks_6]" data-cid='{{$campaign->id}}'   class="my-2 form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher->planned['remarks_6'] ?? '' }}</textarea>
                                            <hr>
                                            <textarea rows="2" placeholder="publisher_url 6" name="url[url_6]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher_common->url['url_6'] ?? '' }}</textarea>
                                            <textarea rows="2" placeholder="Created By 6" name="url[created_by_6]" data-cid='{{$campaign->id}}'   class="my-2 form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher_common->url['created_by_6'] ?? '' }}</textarea>
                                            <textarea rows="2" placeholder="Remarks 6" name="url[remarks_6]" data-cid='{{$campaign->id}}'   class="form-control publisher_url url_cid_{{$campaign->id}}" >{{ $campaign->campaign_publisher_common->url['remarks_6'] ?? '' }}</textarea>
                                        </td>
                                        </form>
                                    </tr>
                                @empty
