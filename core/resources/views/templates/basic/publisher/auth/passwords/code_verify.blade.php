                ...
                <div class="col-lg-6">
                    ...
                    <div class="tab-content mt-5" id="myTabContent">
                        <div class="tab-pane fade show active" id="publisher" role="tabpanel" aria-labelledby="publisher-tab">
                            <form action="{{ route('publisher.password.verify-code') }}" method="POST" class="cmn-form mt-30">
                                @csrf
                                ...
                                <div class="form-group text-center">
                                <a class="text-primary font-weight-bold " href="{{ route('publisher.password.reset') }}">@lang('Try again')</a>
                            </div>
                            </form>
                        </div>
