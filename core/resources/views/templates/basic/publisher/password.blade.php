    ...
    <div class="col-lg-6 mb-30">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('publisher.password.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
...
@push('breadcrumb-plugins')
    <a href="{{route('publisher.profile')}}" class="btn btn-sm btn--primary box--shadow1 text--small" ><i class="fa fa-user"></i>@lang('Profile Setting')</a>
@endpush
