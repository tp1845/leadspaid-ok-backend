                                    ...
                                    <tr>
                                        ...
                                        <div class="wrapper wrapper_span">
                                          ...
                                          <span>@if($campaign->approve==0) Pending @elseif($campaign->approve==1) Approve @elseif($campaign->approve==2) Rejected @endif </span>
                                            ...
                                            <!--input type="checkbox" name="approve" @if($campaign->approve) checked @endif  data-toggle="toggle" data-size="small" data-onstyle="success" data-style="ios" class="toggle-approve" data-id="{{$campaign->id}}" --></td>
