                    ...
                    <div class="table-responsive--md  table-responsive">
                        <table class="table table--light style--two" id="datatable5">
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Phone')">{{ $advertiser->phone }}</td>
                                ...
                                <td data-label="@lang('Actions')">
                                    <a href="{{ route('admin.advertiser.active',['id'=>$advertiser->id]) }}" class="icon-btn btn--success mr-2" data-toggle="tooltip" data-original-title="@lang('make active')">
