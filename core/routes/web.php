...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['admin'])->group(function () {
       ...
       Route::post('admin/checkmail','PublisherController@checkmail')->name('admin/checkmail');
        // Users Manager
...
Route::namespace('Advertiser')->prefix('advertiser')->name('advertiser.')->group(function () {
    ...
    Route::middleware(['advertiser','checkStatus:advertiser'])->group(function () {
        ...
        Route::post('/campaigns/getform', 'CampaignsdemoController@getform')->name('campaigns.getform');
